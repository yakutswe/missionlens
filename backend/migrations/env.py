...
from backend.app.db.models import (
    ReportRecord, CaseRecord, CaseReportRecord, ApprovalRequestRecord, AuditEventRecord,
)
...
MANAGED_TABLES = {"reports", "cases", "case_reports", "approval_requests", "audit_events"}
